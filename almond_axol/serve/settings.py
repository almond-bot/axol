...
SETTINGS: tuple[SettingCategory, ...] = (
    SettingCategory(
        ...
        settings=(
            ...
            # attached (arm hub, Jelly wheel bus, lift bus) — these three are
            # the operator's opt-out for hardware that is plugged in.
            SettingDef(
                key="robot.arms",
                label="Axol arms",
                type="boolean",
            ...
            SettingDef(
                ...
                help=(
                    ...
                    "policies never control it. Jelly parameters live under "
                    "Advanced → Jelly."
                ),
            ),
            SettingDef(
