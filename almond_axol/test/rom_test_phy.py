...
async def _run() -> None:
    ...
    try:
        ...
        right_open = home.copy()
        right_open[_IDX[Joint.GRIPPER]] = _GRIPPER_R_OPEN
        left_open = home.copy()
        left_open[_IDX[Joint.GRIPPER]] = _GRIPPER_L_OPEN
        await _sweep_unchecked(
            axol, home, home, left_open, right_open, speed=_GRIPPER_SPEED
        )
        ...
        right_closed[_IDX[Joint.GRIPPER]] = _GRIPPER_R_CLOSED
        await _sweep_unchecked(
            axol, left_open, right_open, left_open, right_closed, speed=_GRIPPER_SPEED
        )
        ...
        left_closed[_IDX[Joint.GRIPPER]] = _GRIPPER_L_CLOSED
        await _sweep_unchecked(
            axol,
            left_open,
            right_closed,
