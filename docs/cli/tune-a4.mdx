...
| `--position-kp`, `--position-ki`, `--position-kd`, `--speed-kp`, `--speed-ki`, `--current-kp`, `--current-ki` | Firmware gains for the run (default: leave as is) |
...
| `--iq-abort A` | Abort past this reply current (default: 10; 0 off) |
