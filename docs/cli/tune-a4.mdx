...
| `--no-imu` | Skip the wrist IMU (recorded by default: the run gets an `imu` shake score — 3–15 Hz displacement p2p in mm at the gripper, see [`tune.motion`](/cli/tune-motion)) |
