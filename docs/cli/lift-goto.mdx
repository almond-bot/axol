...
Moves Jelly's telescoping lift to a target height, given as percent of its homed travel. The default target of **75%** is the **robot install height** — high enough to slide the robot comfortably onto its Jelly mount.
