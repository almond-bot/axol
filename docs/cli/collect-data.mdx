...
| `--robot_config.cameras.<name>.host IP` | IP of the ZED streamer for a camera (`<name>` ∈ `overhead`/`left_arm`/`right_arm`; default `192.168.10.1`, ports 30000/30002/30004) |
...
axol collect-data --repo_id myorg/pick-place --task "Pick the red cube" --fps 30 --zed_iface eth0
