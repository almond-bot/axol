...
<Warning>
  Playback runs stiff. A fast leg carries real momentum and the arm will not yield if the path meets something unexpected — work up to a speed with the workspace clear.
</Warning>
