...
Before starting, finish the [Mantis hardware setup](/mantis/hardware): the hub connected, **Mantis** selected on its tile, the CAN side mapping confirmed, and the grippers-only teleop check passed. Then open **Mantis settings → Tracking**, choose the source, and press **Save settings**.
