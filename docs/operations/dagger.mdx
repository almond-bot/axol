  ...
  <Tab title="Control Panel">
    <Steps>
      <Step title="Connect the robot and assign cameras">
        Connect the **Axol Host** and **Axol**, then assign the cameras the policy was trained on under **Axol settings → Cameras** (at least one, recording enabled). See [Cameras](/guides/control-panel#cameras).
      </Step>
...
<CardGroup cols={2}>
  <Card title="Config Parameters" icon="sliders" href="/operations/dagger-config">
    Every setting for DAgger collection, with its default.
  </Card>
