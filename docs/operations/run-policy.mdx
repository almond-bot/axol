  ...
  <Tab title="Control Panel">
    <Steps>
      ...
      <Step title="Start and control rollouts">
        ...
        | **Return to rest** | Send the limp arms home, replanning the collision-aware return from wherever they were left. Appears after a **Discard** (limp cleanup) or when the guarded between-episode return meets resistance (a **Contact** hold). |
