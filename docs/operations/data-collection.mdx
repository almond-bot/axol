...
<Steps>
  ...
  <Step title="Record with the source-appropriate control">
    ...
    While recording, rapidly fully squeeze and release either trigger **three times** to end and save, or **four times** to end and discard (the same outcome as the panel's **Discard episode**). Three presses resolve after a short pause so a fourth can still select discard.
  </Step>
