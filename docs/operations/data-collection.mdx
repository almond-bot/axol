...
| — | Thumbsticks | **Drive [Jelly](/guides/vr-interface#powered-cart)** (robots so equipped) to reposition between takes — operator mobility only, so Jelly motion is **never recorded** into the dataset |
