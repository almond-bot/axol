...
<CardGroup cols={2}>
  <Card title="Config Parameters" icon="sliders" href="/operations/data-collection-config">
    Every setting for data collection, with its default.
  </Card>
