...
| `l_stick_x` / `l_stick_y` | `float [-1, 1]` | Left thumbstick axes (right = +1; pushed forward = -1). Drive [Jelly](/guides/vr-interface#powered-cart)'s translation when one is configured |
