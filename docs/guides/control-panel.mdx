...
| **Robot** | Left/right arm stiffness sliders, CAN channels, gripper torque limit and max speed (both grippers), gravity-comp damping and rate, and the **Powered cart** toggle (drives the [powered cart](/guides/vr-interface#powered-cart) from the headset thumbsticks in teleop and data collection). |
