...
| **System** | Log level. |
| **Advanced** | Every remaining per-operation field — per-joint gains, IK weights, VR server ports, … — flattened into plain sections (pick the operation, then a section like *axol* or *kinematics*), with a search box across all of it. Nothing is hidden behind collapsed groups. |
