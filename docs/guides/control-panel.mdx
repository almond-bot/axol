...
| **Return to rest** | Send the limp arms home, replanning the collision-aware return from where they are. Appears whenever the arms are left limp: after a **Discard** (phase **Limp**), or when the guarded between-episode return meets resistance (phase **Contact**). Clear the arms by hand first. |
