...
| Either thumbstick click | Toggle the **grasp**: *straight* (the default — fingers straight forward, 0°, width between the mounts) or *flush* (the tool's contact face along the box side — the parcel gripper's folded blade, 38.5° inward, width between the faces). The pair blends over; the **Box** button names the grasp |
