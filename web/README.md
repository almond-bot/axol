...
| Either thumbstick ↑ ↓ | **Tilt** trim on top of the grasp's yaw: pull back = fingertips inward, push forward = outward, pivoting about the contact face (the **Box** button shows the trim) |
