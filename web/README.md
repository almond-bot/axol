...
| Either thumbstick click | Toggle the **grasp**: *flush* (the tool's contact face along the box side — the parcel gripper's folded blade, 38.5° inward, width between the faces) or *straight* (fingers straight forward, width between the mounts). The pair blends over; the **Box** button names the grasp |
